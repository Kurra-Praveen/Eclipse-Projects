...
public class Driver {
	...
	public static AppiumDriver<MobileElement> getAppiumDriver() {
		...
		try {
			...
			cap.setCapability(MobileCapbilitiesEx.APP_PACKAGE, "com.flipkart.android");
			
			cap.setCapability(MobileCapbilitiesEx.APP_ACTIVITY, "com.flipkart.android.SplashActivity");
